...
class WebCamPointing:
    ...
    def capture_and_findstar(self,center_try):
        ...
        n, centroid_x,centroid_y = self.starfind_method2(a)
        ...
        #cv2.destroyAllWindows()
        if (n==1):
            xcenter = 386.3025173389589
            ycenter = 230.1723461326891
            # print(width,height,arrcX[indexofbright],arrcY[indexofbright])
