...
class Seeing:
    ...
    def starfind_method2(self,im):
        ...
        if(str(type(sources))!="<class 'NoneType'>"):
            ...
            if(n==2):
                ...
                # Imp: Arrange the messing  x1,y1 and x2,y2 array
    ...
    def seeing_fried_y(self,v):
        ...
        return seeing
def main():
    #For StandAlone Analysis operation
    ...
    if (starnotfound < 50):
        ...
        print("Saravin/Tokovin model (Not Airmass corrected):  Combined Seeing= %f Seeing X = %f, Seeing Y = %f" % ((seeing_x_saravin+seeing_y_saravin)/2,seeing_x_saravin, seeing_y_saravin))
        ...
        print("Fried model (Not Airmass corrected):  Combined Seeing= %f Seeing X = %f, Seeing Y = %f" % ((seeing_x_fried+seeing_y_fried)/2,seeing_x_fried, seeing_y_fried))
